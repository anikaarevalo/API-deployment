...
**(Pipeline 1)** A heat map, showing the correlations among the numerical variables forming the baseline data frame
 ...
 **(Piperline 2)** Multiple regression model: RSquared performance metric score of 22%
...
**(Pipeline 3)** Immo Eliza house price calculator user interface 
